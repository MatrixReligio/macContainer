...
require_text App/PrivilegedHelper/main.swift 'dispatchMain()'
...
require_text scripts/release.sh '-derivedDataPath "$artifacts/DerivedData"'
require_text scripts/release.sh 'CODE_SIGNING_ALLOWED=NO'
