...
> **시험판:** 버전 0.1.8은 Apple Silicon과 macOS 26 이상이 필요합니다. 중요한 컨테이너 데이터는 별도로 백업하고 파괴적 작업 전에 모든 값을 검토하십시오.
...
- 처음 사용할 때 부팅 검증을 마친 Alpine 3.22 가상 머신 이미지를 자동으로 준비하며 생성 후 내장 터미널로 접근할 수 있습니다.
- 컨테이너 안내 흐름에서 OCI 이미지, 컨테이너 네트워크, 명명된 영구 볼륨을 한 번에 검토하고 연결할 수 있습니다.
